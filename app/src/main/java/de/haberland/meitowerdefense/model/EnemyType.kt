 ...
 * [livesCost] is how many lives are lost if this enemy reaches the end - 1 for everything
 * except BOSS, which should feel like a real, costly failure rather than routine chip
 * damage.
 */
